...
class ToolsDialog:
    ...
    def _refresh_pending(self) -> None:
        ...
        if tool in ("cc_mouse_click", "cc_mouse_click_at", "cc_double_click_and_type", "cc_click_template", "cc_click_template_live", "cc_click_target_live"):
    ...
    def _approve_with_popup_for_cc_click(self) -> None:
        ...
        tool = pending.get("tool")
        if tool not in ("cc_mouse_click", "cc_mouse_click_at", "cc_double_click_and_type", "cc_click_template", "cc_click_template_live", "cc_click_target_live"):
            self._approve()
            return
